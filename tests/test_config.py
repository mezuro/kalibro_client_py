...
class TestConfig(object):
    ...
    def test_configure_just_processor_address(self):
       ...
       assert_equal(kalibro_client.config()['processor_address'], processor_address)
    ...
    def test_configure_just_configurations_address(self):
       ...
       assert_equal(kalibro_client.config()['configurations_address'], configurations_address)
    ...
    def test_configure(self):
        ...
        kalibro_client.configure(processor_address=processor_address, configurations_address=configurations_address)
